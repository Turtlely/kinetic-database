...
def create_databases():
    ...
    try:
        ...
        print("databases were previously created. Exiting now.")
        conn.close()
        sys.exit()
    conn.close()
...
def create_user_table():
    ...
    conn.execute('''CREATE TABLE User(user_id BIGINT UNSIGNED PRIMARY KEY UNIQUE NOT NULL,
...
def create_tables():
    ...
    conn.execute('''CREATE TABLE Atoms(atoms_id      BIGINT UNSIGNED PRIMARY KEY UNIQUE NOT NULL, 
    ...
    conn.execute('''CREATE TABLE Atom(atom_id  BIGINT UNSIGNED PRIMARY KEY UNIQUE NOT NULL, 
                                      atoms_id BIGINT UNSIGNED NOT NULL,
    ...
    conn.execute('''CREATE TABLE Process(pro_id          BIGINT UNSIGNED PRIMARY KEY UNIQUE NOT NULL,
                                         name           TEXT NOT NULL,
                                         original_pro_id BIGINT UNSIGNED NOT NULL,
                                         reactant_id     BIGINT UNSIGNED NOT NULL,
                                         saddle_id       BIGINT UNSIGNED NOT NULL,
                                         product_id      BIGINT UNSIGNED NOT NULL,
                                         elemental_code  BIGINT UNSIGNED NOT NULL,
                                         elemental_type_code  BIGINT UNSIGNED NOT NULL,
                                         barrier_forward      REAL NOT NULL,
                                         barrier_reverse      REAL NOT NULL,
    ...
    conn.execute('''CREATE TABLE Mobile(mob_id BIGINT UNSIGNED PRIMARY KEY UNIQUE NOT NULL,
                                        num    INT UNSIGNED NOT NULL,
